...
import backgroundImage from '../Pictures/Group Pic - Installation.jpg';
...
const Hero = () => {
  return (
    <section 
      ...
      style={{
        backgroundImage: `linear-gradient(to bottom right, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.3)), url(${backgroundImage})`,
